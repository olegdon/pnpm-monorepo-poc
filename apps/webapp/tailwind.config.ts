...
export default {
  ...
  ...require("@olegdon/pnpm-monorepo-poc-ui/tailwind.config.ts"),
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        sm: "0 0.25px 0.75px 0 rgba(0,0,0,0.15), 0 0.5px 1.5px 0 rgba(0,0,0,0.15)",
        default:
          "0 0.5px 1.5px 0 rgba(0,0,0,0.13), 0 1px 3px 0 rgba(0,0,0,0.13)",
        md: "0 0.75px 2.25px 0 rgba(0,0,0,0.11), 0 1.5px 6px 0 rgba(0,0,0,0.11)",
        lg: "0 1px 3px 0 rgba(0,0,0,0.09), 0 2px 12px 0 rgba(0,0,0,0.09)",
        xl: "0 1.25px 3.75px 0 rgba(0,0,0,0.07), 0 2.5px 24px 0 rgba(0,0,0,0.07)",
        "2xl":
